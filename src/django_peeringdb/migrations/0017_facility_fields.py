...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(blank=True, help_text='Two separate and distinct paths to individual substations which should maintain a separated path back to one or more utility generator stations.', null=True, verbose_name='Diverse Serving Substations'),
        ),
        migrations.AddField(
            model_name='facility',
            name='property',
            field=models.CharField(blank=True, choices=[('', 'Not Disclosed'), ('Owner', 'Owner'), ('Lessee', 'Lessee')], help_text='A property owner is the individual or entity that has title to the property. A lessee is a user of a property who has a lease, an agreement, with the owner of the property.', max_length=27, null=True, verbose_name='Property'),
        ),
    ]
